    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative pt-20 pb-20 overflow-hidden min-h-[90vh] flex items-center">
          {/* Animated gradient background - bordeaux/marron */}
          <div className="absolute inset-0 bg-gradient-to-br from-red-900 via-rose-950 to-stone-900 animate-gradient" />
          
          {/* Animated circles - tons bordeaux */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-20 -left-20 w-96 h-96 bg-red-700/30 rounded-full blur-3xl animate-float" />
            <div className="absolute top-1/2 -right-32 w-80 h-80 bg-rose-800/40 rounded-full blur-3xl animate-float animation-delay-400" />
            <div className="absolute -bottom-20 left-1/3 w-72 h-72 bg-amber-900/30 rounded-full blur-3xl animate-float animation-delay-600" />
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-10 items-center">
                {/* Affiche avec effet glow bordeaux */}
                <div className="flex justify-center order-2 md:order-1 animate-fade-up">
                  <div className="relative group">
                    <div className="absolute -inset-4 bg-gradient-to-r from-red-800 via-rose-700 to-amber-800 rounded-3xl blur-2xl opacity-60 group-hover:opacity-80 transition-opacity duration-500 animate-pulse-glow" />
                    <img 
                      src={heroImage} 
                    ...
                    />
                    {/* Badge flottant */}
                    <div className="absolute -top-4 -right-4 bg-red-700 text-white font-bold px-4 py-2 rounded-full shadow-xl animate-bounce-subtle">
                ...
                <div className="text-center md:text-left order-1 md:order-2">
                  <div className="animate-fade-up">
                    <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-5 py-2.5 rounded-full mb-6 border border-white/30">
                      <Mic className="w-5 h-5 text-amber-300 animate-bounce-subtle" />
                  ...
                  <h1 className="font-display text-5xl md:text-7xl text-white mb-4 drop-shadow-2xl animate-fade-up animation-delay-200">
                    <span className="bg-gradient-to-r from-amber-200 via-red-200 to-white bg-clip-text text-transparent">
                      {t('meryl.title')}
                    </span>
                  </h1>
                  
                  <p className="text-2xl md:text-3xl text-amber-100 font-display mb-8 animate-fade-up animation-delay-400">
                    {t('meryl.subtitle')}
                  </p>
                  ...
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-10 animate-fade-up animation-delay-600">
                    <div className="flex items-center gap-2 bg-white/25 backdrop-blur-md px-5 py-3 rounded-full text-white font-bold text-sm border border-white/30 hover:bg-white/35 transition-colors">
                      <Calendar className="w-5 h-5 text-amber-300" />{t('meryl.dateInfo')}
                    </div>
                    <div className="flex items-center gap-2 bg-white/25 backdrop-blur-md px-5 py-3 rounded-full text-white font-bold text-sm border border-white/30 hover:bg-white/35 transition-colors">
                    ...
                    <div className="grid grid-cols-4 gap-3 md:gap-5 text-center">
                      {[
                        ...
                        <div key={idx} className="group">
                          <div className="bg-gradient-to-br from-red-800 via-rose-800 to-amber-900 rounded-2xl px-3 md:px-5 py-3 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                            <span className="font-display text-2xl md:text-4xl text-white font-bold drop-shadow-lg">{item.value}</span>
                          </div>
                          <p className="text-amber-200 text-xs mt-2 uppercase font-bold tracking-wide">{item.label}</p>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        {/* Exclusive Offers - 3 columns - tons bordeaux */}
        <section className="py-10 bg-gradient-to-br from-red-50 via-white to-amber-50 dark:from-red-950/20 dark:via-background dark:to-amber-950/20">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-800 to-rose-900 text-white px-5 py-2 rounded-full mb-2 shadow-lg">
              ...
              <div className="grid md:grid-cols-3 gap-5">
                ...
                <div className="bg-white dark:bg-card rounded-2xl p-5 shadow-xl border-2 border-red-200 dark:border-red-800/50 hover:scale-[1.02] transition-transform duration-300 group">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-red-700 to-red-800 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      <Car className="w-6 h-6 text-white" />
                    </div>
                    <div>
                      <h3 className="font-display text-lg text-foreground">{t('meryl.parking')}</h3>
                      <div className="inline-block bg-red-800 text-white font-bold text-base px-2.5 py-0.5 rounded-full">{t('meryl.parkingPrice')}</div>
                    </div>
                  </div>
                ...
                {/* Taxi */}
                <div className="bg-white dark:bg-card rounded-2xl p-5 shadow-xl border-2 border-rose-200 dark:border-rose-800/50 hover:scale-[1.02] transition-transform duration-300 group">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-rose-800 to-rose-900 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      <Car className="w-6 h-6 text-white" />
                    </div>
                    <div>
                      <h3 className="font-display text-lg text-foreground">{t('meryl.taxi')}</h3>
                      <div className="inline-block bg-rose-800 text-white font-bold text-base px-2.5 py-0.5 rounded-full">{t('meryl.taxiDiscount')}</div>
                    </div>
                  </div>
                ...
                {/* T-shirt Raffle */}
                <div className="bg-white dark:bg-card rounded-2xl p-5 shadow-xl border-2 border-amber-200 dark:border-amber-800/50 hover:scale-[1.02] transition-transform duration-300 group relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Trophy className="w-4 h-4 text-amber-600" />
                  </div>
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-amber-700 to-amber-800 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      <Shirt className="w-6 h-6 text-white" />
                    </div>
                    <div>
                      <h3 className="font-display text-lg text-foreground">{t('concert.raffle.title').replace('!', '')}</h3>
                      <span className="text-xs text-red-700 dark:text-red-400 font-medium uppercase tracking-wide">{t('concert.raffle.badge')}</span>
                    </div>
                  </div>
        ...
        <EasyAccessSection 
          ...
          accentColor="from-red-800 via-rose-800 to-amber-800"
        />

        {/* About Section - Artist History */}
        <section className="py-16 bg-white dark:bg-background relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-800 via-rose-700 to-amber-700" />
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-100 to-amber-100 dark:from-red-900/40 dark:to-amber-900/40 text-red-800 dark:text-red-300 px-6 py-3 rounded-full mb-4 shadow-lg">
        ...
        <section className="py-20 bg-gradient-to-br from-red-50 via-rose-50 to-amber-50 dark:from-red-950/20 dark:via-rose-950/20 dark:to-amber-950/20">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-800 to-rose-800 text-white px-6 py-3 rounded-full mb-4 shadow-lg">
