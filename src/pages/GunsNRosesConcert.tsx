    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative pt-20 pb-20 overflow-hidden min-h-[90vh] flex items-center">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-red-900 via-black to-yellow-900 animate-gradient" />
              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div className="flex justify-center order-2 md:order-1 animate-fade-up">
                  <div className="relative group">
                    <div className="absolute -inset-4 bg-gradient-to-r from-red-500 via-yellow-500 to-red-600 rounded-3xl blur-2xl opacity-60 group-hover:opacity-80 transition-opacity duration-500 animate-pulse-glow" />
                    <img 
                      src={heroImage} 
                    ...
                    <div className="grid grid-cols-4 gap-3 md:gap-5 text-center">
                      {[
                        ...
                        <div key={idx} className="group">
                          <div className="bg-gradient-to-br from-red-500 via-yellow-500 to-red-600 rounded-2xl px-3 md:px-5 py-3 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
