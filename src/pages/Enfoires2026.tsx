      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-10">
                ...
                <h2 className="font-display text-3xl md:text-4xl mb-2">{t('enfoires.specialOffer')}</h2>
                <p className="text-pink-200">{t('enfoires.bestConditions')}</p>
              </div>
              <div className="text-center">
                <Link to="/reservation-seminaire">
                  <Button size="lg" className="bg-white text-pink-600 hover:bg-pink-50 font-bold px-10 py-6 text-lg shadow-xl hover:scale-105 transition-all duration-300">
                    <Heart className="w-5 h-5 mr-3" fill="currentColor" />{t('enfoires.bookNow')}
                  </Button>
                </Link>
              </div>
            </div>
        ...
        <section className="py-16 bg-gradient-to-br from-pink-100 via-white to-fuchsia-100 dark:from-pink-950/30 dark:via-card dark:to-fuchsia-950/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-10">
                <h2 className="font-display text-3xl md:text-4xl text-foreground mb-2">{t('enfoires.exclusiveOffers')}</h2>
                <p className="text-muted-foreground">{t('enfoires.offersSubtitle')}</p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-card rounded-2xl p-8 shadow-xl border-2 border-pink-200 dark:border-pink-800/50 hover:scale-105 transition-transform duration-300">
                  ...
                  <h3 className="font-display text-2xl text-foreground mb-2">{t('enfoires.parking')}</h3>
                  <p className="text-muted-foreground mb-4">{t('enfoires.parkingDesc')}</p>
                  <div className="inline-block bg-pink-600 text-white font-bold text-xl px-4 py-2 rounded-full">{t('enfoires.parkingPrice')}</div>
                </div>
                <div className="bg-white dark:bg-card rounded-2xl p-8 shadow-xl border-2 border-fuchsia-200 dark:border-fuchsia-800/50 hover:scale-105 transition-transform duration-300">
                  ...
                  <h3 className="font-display text-2xl text-foreground mb-2">{t('enfoires.taxi')}</h3>
                  <p className="text-muted-foreground mb-4">{t('enfoires.taxiDesc')}</p>
                  <div className="inline-block bg-fuchsia-600 text-white font-bold text-xl px-4 py-2 rounded-full">{t('enfoires.taxiDiscount')}</div>
                </div>
              </div>
