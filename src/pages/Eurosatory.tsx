    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section className="relative py-24 overflow-hidden">
          <img src={heroSeminaire} alt="Eurosatory" className="absolute inset-0 w-full h-full object-cover object-center" />
          <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent" />
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div className="text-left">
                <div className="inline-flex items-center gap-2 bg-slate-700/90 backdrop-blur-sm text-white px-4 py-2 rounded-full mb-4 shadow-lg">
                  <Shield className="w-4 h-4" />
                  <span className="font-medium text-sm uppercase tracking-wider">{t('eurosatory.badge')}</span>
                </div>
                <h1 className="font-display text-4xl md:text-6xl text-white drop-shadow-lg mb-4">{t('eurosatory.title')}</h1>
                <p className="text-white/90 text-lg md:text-xl">{t('eurosatory.subtitle')}</p>
              </div>

              <div className="bg-slate-50/95 dark:bg-slate-950/90 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-2xl border border-slate-200/50 dark:border-slate-800/50">
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3 bg-white dark:bg-card px-4 py-3 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                    <Calendar className="w-5 h-5 text-slate-600" />
                    <span className="text-slate-800 dark:text-slate-200 font-medium">{t("eurosatory.dateDisplay")}</span>
                  </div>
                  <div className="flex items-center gap-3 bg-white dark:bg-card px-4 py-3 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                    <MapPin className="w-5 h-5 text-slate-600" />
                    <span className="text-slate-800 dark:text-slate-200 font-medium">{t("eurosatory.venue")}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-4 gap-2 mb-6">
                  {[
                    ...
                    <div key={index} className="bg-white dark:bg-card border-2 border-slate-200 dark:border-slate-700 rounded-xl p-3 text-center shadow-sm">
                      <div className="text-2xl md:text-3xl font-bold text-slate-700 dark:text-slate-400">{item.value}</div>
                      <div className="text-xs text-slate-600 dark:text-slate-500 uppercase tracking-wide">{item.label}</div>
                    </div>
                  ))}
                </div>

                <a href="https://www.booking.com" target="_blank" rel="noopener noreferrer" className="block">
                  <Button size="lg" className="w-full bg-slate-700 hover:bg-slate-800 text-white font-bold shadow-lg">
        ...
        <section className="py-12 bg-gradient-to-br from-slate-50 via-zinc-50 to-slate-50 dark:from-slate-950/30 dark:via-zinc-950/20 dark:to-slate-950/30">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <div className="bg-white dark:bg-card rounded-2xl p-6 shadow-xl border-2 border-slate-200 dark:border-slate-800/50 hover:scale-105 transition-transform duration-300 text-center">
                ...
                <div className="inline-block bg-slate-700 text-white font-bold px-4 py-2 rounded-full">{t("agriculture.offers.parking.price")}</div>
              </div>
              <div className="bg-white dark:bg-card rounded-2xl p-6 shadow-xl border-2 border-zinc-200 dark:border-zinc-800/50 hover:scale-105 transition-transform duration-300 text-center">
                <div className="w-14 h-14 bg-zinc-100 dark:bg-zinc-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <div className="inline-block bg-zinc-600 text-white font-bold px-4 py-2 rounded-full">{t("agriculture.offers.taxi.discount")}</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <EasyAccessSection 
          ...
          accentColor="from-slate-700 via-slate-800 to-zinc-700"
        />

        <section className="py-16 bg-gradient-to-br from-slate-50 via-white to-zinc-50 dark:from-slate-950/20 dark:via-card dark:to-zinc-950/20">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
              ...
              <div className="flex justify-center">
                <img src={heroSeminaire} alt="Eurosatory" className="max-w-xs md:max-w-sm rounded-xl shadow-xl object-cover" />
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="bg-card overflow-hidden border border-border">
                ...
                <div className="p-6 text-center">
                  <div className="w-12 h-12 bg-slate-100 dark:bg-slate-900/30 rounded-full flex items-center justify-center mx-auto mb-4 -mt-10 relative z-10 border-4 border-card"><Utensils className="w-6 h-6 text-slate-600" /></div>
              ...
              <div className="bg-card overflow-hidden border border-border">
                ...
                <div className="p-6 text-center">
                  <div className="w-12 h-12 bg-slate-100 dark:bg-slate-900/30 rounded-full flex items-center justify-center mx-auto mb-4 -mt-10 relative z-10 border-4 border-card"><Train className="w-6 h-6 text-slate-600" /></div>
              ...
              <div className="bg-card overflow-hidden border border-border">
                ...
                <div className="p-6 text-center">
                  <div className="w-12 h-12 bg-slate-100 dark:bg-slate-900/30 rounded-full flex items-center justify-center mx-auto mb-4 -mt-10 relative z-10 border-4 border-card"><Users className="w-6 h-6 text-slate-600" /></div>
