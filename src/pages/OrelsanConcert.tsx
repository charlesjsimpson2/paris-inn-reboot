      ...
      <main>
        ...
        <section className="relative pt-20 pb-20 overflow-hidden min-h-[90vh] flex items-center">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/2 -right-32 w-80 h-80 bg-cyan-500/40 rounded-full blur-3xl animate-float animation-delay-400" />
          </div>
        ...
        <section className="py-16 bg-white dark:bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-muted-foreground text-xl leading-relaxed max-w-2xl mx-auto">{t('orelsan.showDesc')}</p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="bg-white dark:bg-charcoal rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-emerald-200 dark:border-emerald-800/50 overflow-hidden relative">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-5 relative">
                  <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: t('orelsan.aboutText1') }} />
                  <p className="leading-relaxed" dangerouslySetInnerHTML={{ __html: t('orelsan.aboutText2') }} />
                  <p className="leading-relaxed" dangerouslySetInnerHTML={{ __html: t('orelsan.aboutText3') }} />
                </div>
              </div>
            </div>
          </div>
