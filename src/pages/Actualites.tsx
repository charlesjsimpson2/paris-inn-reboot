...
import franceAngleterreMatch from "@/assets/france-angleterre-hero-gen.jpg";
import salonAgricultureHero from "@/assets/salon-agriculture.webp";
import mikaHero from "@/assets/mika-spinning-out-tour.webp";
import claraHero from "@/assets/clara-luciani-portrait.jpg";
import semiMarathonHero from "@/assets/semi-marathon-hero-gen.jpg";
...
import marathonParisHero from "@/assets/marathon-paris-hero-gen.jpg";
...
const Actualites = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      date: "18-19 " + t('mika.february') + " 2026",
      sortDate: "2026-02-18",
      endDate: "2026-02-19",
      location: "Accor Arena Paris",
      category: t('actualites.concert'),
