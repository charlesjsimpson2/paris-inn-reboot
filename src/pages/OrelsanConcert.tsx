...
const OrelsanConcert = () => {
  ...
  const targetDate = new Date('2026-12-09T20:00:00').getTime();
      ...
      <main>
        ...
        <section className="relative pt-20 pb-20 overflow-hidden min-h-[90vh] flex items-center">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-20 -left-20 w-96 h-96 bg-emerald-400/20 rounded-full blur-3xl animate-float" />
            <div className="absolute top-1/2 -right-32 w-80 h-80 bg-cyan-500/30 rounded-full blur-3xl animate-float animation-delay-400" />
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 mb-10 animate-fade-up animation-delay-600">
                ...
                <div className="flex items-center gap-2 bg-white/25 backdrop-blur-md px-5 py-3 rounded-full text-white font-bold text-sm border border-white/30">
                  <MapPin className="w-5 h-5 text-cyan-300" />Accor Arena Paris
                </div>
              </div>
                ...
                <div className="grid grid-cols-4 gap-3 md:gap-5 text-center">
                  {[
                    ...
                    <div key={idx} className="group">
                      <div className="bg-gradient-to-br from-emerald-500 via-teal-600 to-cyan-600 rounded-2xl px-3 md:px-5 py-3 shadow-lg">
        ...
        <section className="py-10 bg-gradient-to-br from-emerald-50 via-white to-cyan-50 dark:from-emerald-950/20 dark:via-background dark:to-cyan-950/20">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-6">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-cyan-600 text-white px-5 py-2 rounded-full mb-2 shadow-lg">
                  <Gift className="w-4 h-4" />
                  <span className="font-bold text-sm uppercase tracking-wider">{t('orelsan.exclusiveOffers')}</span>
                </div>
                <p className="text-muted-foreground text-sm">{t('orelsan.offersSubtitle')}</p>
              </div>
              
              <div className="grid md:grid-cols-3 gap-5">
                {/* Parking */}
                <div className="bg-white dark:bg-card rounded-2xl p-5 shadow-xl border-2 border-emerald-200 dark:border-emerald-800/50 hover:scale-[1.02] transition-transform duration-300 group">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-display text-lg text-foreground">{t('orelsan.parking')}</h3>
                      <div className="inline-block bg-emerald-600 text-white font-bold text-base px-2.5 py-0.5 rounded-full">{t('orelsan.parkingPrice')}</div>
                    </div>
                  </div>
                  <p className="text-muted-foreground text-sm">{t('orelsan.parkingDesc')}</p>
                </div>

                {/* Taxi */}
                <div className="bg-white dark:bg-card rounded-2xl p-5 shadow-xl border-2 border-cyan-200 dark:border-cyan-800/50 hover:scale-[1.02] transition-transform duration-300 group">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-display text-lg text-foreground">{t('orelsan.taxi')}</h3>
                      <div className="inline-block bg-cyan-600 text-white font-bold text-base px-2.5 py-0.5 rounded-full">{t('orelsan.taxiDiscount')}</div>
                    </div>
                  </div>
                  <p className="text-muted-foreground text-sm">{t('orelsan.taxiDesc')}</p>
                </div>

                {/* T-shirt Raffle */}
                <div className="bg-white dark:bg-card rounded-2xl p-5 shadow-xl border-2 border-teal-200 dark:border-teal-800/50 hover:scale-[1.02] transition-transform duration-300 group relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-emerald-600 dark:text-emerald-400 font-medium uppercase tracking-wide">{t('concert.raffle.badge')}</span>
                    </div>
                  </div>
              ...
              <p className="text-center text-xs text-muted-foreground mt-4 italic">{t('orelsan.offersNote')}</p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-100 to-cyan-100 dark:from-emerald-900/40 dark:to-cyan-900/40 text-emerald-700 dark:text-emerald-300 px-6 py-3 rounded-full mb-4 shadow-lg">
                  <History className="w-5 h-5" />
                  <span className="font-bold text-sm uppercase tracking-wider">{t('orelsan.artistHistory')}</span>
                </div>
              ...
              <div className="space-y-6 text-muted-foreground max-w-4xl mx-auto">
                <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: t('orelsan.history1') }} />
                <p className="leading-relaxed" dangerouslySetInnerHTML={{ __html: t('orelsan.history2') }} />
                <p className="leading-relaxed" dangerouslySetInnerHTML={{ __html: t('orelsan.history3') }} />
                <p className="leading-relaxed" dangerouslySetInnerHTML={{ __html: t('orelsan.history4') }} />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-cyan-600 text-white px-6 py-3 rounded-full mb-4 shadow-lg">
                  <Sparkles className="w-5 h-5 animate-pulse" />
                  <span className="font-bold text-sm uppercase tracking-wider">{t('orelsan.normandy')}</span>
                </div>
        ...
        <EventHotelPromo 
          eventName={t("orelsan.title")}
          accentColor="from-emerald-600 via-teal-700 to-cyan-800"
          urgencyMessage={t("orelsan.urgencyMessage")}
          compact
        />

        {/* Related Events */}
        <RelatedEvents currentEventId="orelsan" />
      </main>
      <Footer />
    </div>
  );
