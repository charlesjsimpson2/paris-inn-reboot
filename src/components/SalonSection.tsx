  ...
  return (
    <div className="relative min-h-[500px] lg:min-h-[550px]">
      ...
      <div className={`relative z-10 min-h-[500px] lg:min-h-[550px] flex items-center ${reverse ? 'lg:justify-start' : 'lg:justify-end'}`}>
        <div className={`w-full lg:w-[50%] bg-background/95 backdrop-blur-sm lg:bg-background p-8 lg:p-10 ${reverse ? 'lg:ml-8' : 'lg:mr-8'} lg:my-12 lg:shadow-2xl lg:rounded-sm`}>
          
          <div className="flex gap-6">
            {/* Burgundy vertical line next to text */}
            ...
            <div className="flex-1">
              ...
              {/* CTA Button */}
              <a 
                href="mailto:contact@hotel-inn-paris.fr?subject=Demande de devis - ${salon.name}"
                className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-sm font-medium text-sm uppercase tracking-wider hover:bg-primary/90 transition-colors"
              >
                Demander un devis
              </a>
            </div>
